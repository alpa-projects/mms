...
python3 plot_various_metrics.py --input ablation_general_synthetic_bert_all/res_general_vs_all.tsv --general --synthetic --pdf

python3 plot_various_metrics.py --input ablation_general_synthetic_mixed_all/res_general_vs_all.tsv --general --synthetic --pdf
